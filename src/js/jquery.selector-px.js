;(function($){
    ...
    $('body').append('<style>'+
                ...
                '.sel-box .btn{background:#ffffff;overflow:hidden;}'+
                '.sel-box .btn1{overflow:hidden;width:50px;height:44px;line-height:44px;float:left;font-size:10px;color:rgb(153,153,153);padding:0 12px;}'+
                '.sel-box .ok{float:right;color:rgb(44,104,219)}'+
                '.sel-box .name{color:white;text-align:center;line-height:22px;font-size:18px;padding:11px 0;}'+
                '.sel-con{background:white;}'+
                '.sel-con .border{height:34px;border:solid 1px rgb(222,222,222);border-width:1px 0;position:absolute;bottom:72px;left:0;right:0;pointer-events:none;}'+
